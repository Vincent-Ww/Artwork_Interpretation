...
loss_file = "output_logs/loss_file_ap.txt"
...
#         text_field.build_vocab(train_dataset, val_dataset, min_freq=5)
    ...
    artpedia_train = AP_Dataset(ap_train_dataset, train_item2imgCapIdx, text_field, max_detections=50, lower=True, remove_punctuation=True, tokenize='spacy')
    artpedia_val = AP_Dataset(ap_val_dataset, val_item2imgCapIdx, text_field, max_detections=50, lower=True, remove_punctuation=True, tokenize='spacy')
    artpedia_test = AP_Dataset(ap_test_dataset, test_item2imgCapIdx, text_field, max_detections=50, lower=True, remove_punctuation=True, tokenize='spacy')
