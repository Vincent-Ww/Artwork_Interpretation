...
loss_file = "output_logs/losscurve_sa_multiple_grid_m2rst.txt"
...
#     image_field = ImageDetectionsField(detections_path=args.features_path, max_detections=50, load_in_tmp=False)
    ...
    train_roi_feats = h5py.File("../Dataset/SemArt/sa_train_grid.hdf5", "r")
    val_roi_feats = h5py.File("../Dataset/SemArt/sa_val_grid.hdf5", "r")
    ...
    model_params = torch.load('saved_models/saved_models_saft_grid_m2rst/sa_gridm2rst_sa_last_17epoch.pth')
    model.load_state_dict(model_params['state_dict'])
    print("building model: done !!")
    

    
    semart_train = SA_Dataset(sa_train_csv, train_roi_feats, text_field, max_detections=49, lower=True, remove_punctuation=True,
                   tokenize='spacy')
    semart_val = SA_Dataset(sa_val_csv, val_roi_feats, text_field, max_detections=49, lower=True, remove_punctuation=True,
                   tokenize='spacy')
    semart_test = SA_Dataset(sa_test_csv, test_roi_feats, text_field, max_detections=49, lower=True, remove_punctuation=True,
                   tokenize='spacy')
    print("establish training dataset: done !!")
    
    
    dict_semart_train = SAeval_Dataset(sa_train_csv, train_img_names, train_img_caps_map, test_roi_feats, text_field, max_detections=49, lower=True, remove_punctuation=True, tokenize='spacy')
    dict_semart_val = SAeval_Dataset(sa_val_csv, val_img_names, val_img_caps_map, val_roi_feats, text_field, max_detections=49, lower=True, remove_punctuation=True, tokenize='spacy')
